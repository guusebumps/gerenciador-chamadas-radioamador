...
################################################################################
## Form generated from reading UI file 'atualizar_dados.ui'
##
...
class Ui_InsertWindow(object):
    def setupUi(self, InsertWindow):
        ...
        InsertWindow.setWindowTitle(u"Atualizar dados")
...
"}")
        icon1 = QIcon()
        icon1.addFile(u"Icons/updateicon-removebg-preview-removebg-preview.png", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, InsertWindow):
        self.label_4.setText(QCoreApplication.translate("InsertWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600;\">Atualizar</span></p><p align=\"center\"><span style=\" font-size:18pt; font-weight:600;\">dados</span></p></body></html>", None))
        self.pushButton_2.setText(QCoreApplication.translate("InsertWindow", u"Voltar", None))
        self.label.setText(QCoreApplication.translate("InsertWindow", u"ID", None))
        ...
        self.pushButton.setText(QCoreApplication.translate("InsertWindow", u"Atualizar", None))
        pass
    # retranslateUi
